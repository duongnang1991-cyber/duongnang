...
<div class="main-header">
    ...
    <p>Tác giả: Dương Quý Năng - Trường Tiểu học Phố Cáo - ĐT: 0963789410</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Dương Quý Năng - Trường Tiểu học Phố Cáo - ĐT: 0963789410</div>", unsafe_allow_html=True)
